  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="#"><span class="glyphicon glyphicon-home" style="color:red"></span>首页 <span class="sr-only">(current)</span></a></li>
      ...
      <form class="navbar-form navbar-left">
        <div class="form-group">
          <input type="text" class="form-control" style="width: 500px;" placeholder="请输入搜索内容">
        </div>
        <button type="submit" class="btn btn-default">Submit</button>
      </form>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#">帮助</a></li>
        <li><div id="login"><a href="javascript:void(0)" onclick="show('light')"><span class="glyphicon glyphicon-log-in" style="padding-right: 3px;"></span>登录/注册</a></div></li>
        <li class="dropdown">
          <div id="my">
          ...
          <ul class="dropdown-menu">
            ...
            <li role="separator" class="divider"></li>
            <li><a href="#"><span class="glyphicon glyphicon-log-out" style="padding-right: 3px;"></span>退出登录</a></li>
          </ul>
          </div>
        </li>
      </ul>
...
<div class="container-fluid" style="margin-left: 100px;margin-right: 100px;">
  <div class="row">
    <div class="col-md-2" style="padding-top: 20px;float: left;">
    	<div class="fakeimg"><img alt="帖子图片" src="../img/ahu.png"></div>
    	<br>
    ...
    <div class="col-md-10" style="padding-left: 100px;float: left;">
      <%for(int i=0;i<10;i++){ %>
      <div>
      <a class="title" href="#">用户发表过的帖子</a><br>
