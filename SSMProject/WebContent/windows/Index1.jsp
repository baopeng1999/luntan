...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form class="navbar-form navbar-left" method="get" action="windows/ssearch.jsp">
...
<div id="light" class="white_content">
    ...
    <br/><br>
    <input class="shuru" id="psd" type="password" placeholder="请输入密码" name="password">
    ...
    <form action="register.jsp" method="post" onsubmit="return checkAll()">
    <div class="con">
    <hr color="black">
    ...
    <br/><br/>
    <input class="shuru" id="rtel" type="text" placeholder="请输入联系方式" name="telephone">
    <a class="empty" id="telempty"></a>
    <br/><br/>
    <input class="shuru" id="rpsd" type="password" placeholder="请输入密码" name="password">
